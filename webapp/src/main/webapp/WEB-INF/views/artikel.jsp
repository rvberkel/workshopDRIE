...
<sf:form ID="createArtikel?idArtikel=${artikel.idArtikel}" method="POST" action="/webapp/createArtikel" commandName = "artikel">
	<sf:hidden path="idArtikel"/>
   Naam*: <sf:input path = "artikelnaam"  />
   <sf:errors path = "artikelnaam"/> <br />
   Prijs*: <sf:input path = "artikelprijs"  />
   <sf:errors path = "artikelprijs"/> <br />
   Nummer*: <sf:input path = "artikelnummer"  />
   <sf:errors path = "artikelnummer"/> <br>
   Omschrijving: <sf:input path = "artikelomschrijving"  />
   <sf:errors path = "artikelomschrijving"/> <br />
   *verplicht veld
