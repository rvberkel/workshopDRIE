...
<body>
    <p><a href="KlantController?action=insert">Add Klant</a></p>
    <table border=1>
        <thead>
            <tr>
                <th>KlantID</th>
        ...
        <tbody>
            <c:forEach items="${klanten}" var="klant">
                <tr>
                    ...
                    <td><a href="KlantController?action=edit&idKlant=<c:out value="${klant.idKlant}"/>">Update</a></td>
                    <td><a href="KlantController?action=delete&idKlant=<c:out value="${klant.idKlant}"/>">Delete</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
